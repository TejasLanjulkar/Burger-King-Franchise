...
btn.addEventListener('click', async function (e) {
    ...
    if (burger.checked) {
        ...
        images.push('order-img/burger.avif'); // Image file path for burger
    }
    if (fries.checked) {
        selectedItems.push(fries.id);
        images.push('images/fries.png'); // Image file path for fries
    }
    if (drink.checked) {
        selectedItems.push(drink.id);
        images.push('images/drink.png'); // Image file path for drink
    }
